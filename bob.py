...
async def start_bob():
    async with websockets.connect("ws://localhost:8000/ws") as ws:
        await ws.send(json.dumps({"role": "Bob", "type": "connected"}))
        ...
        #await ws.send(json.dumps({"role": "Bob", "type": "basis_announcement", "basis": bob_bases}))
            ...
            for line in chunk.decode().splitlines():
                ...
                if i >= KEY_LEN and alice_basis_pending is None and "alice_basis" in locals():
                    ...
                    for j in range(KEY_LEN):
                        ...
                        await ws.send(json.dumps({"role": "Bob", "type": "basis_match" if match else "basis_nomatch", "index": j}))
                    ...
                    await ws.send(json.dumps({"role": "Bob", "type": "sifting_complete", "sifted_length": len(sifted), "percentage": pct}))
